alter table if exists public.registro_medicacao disable row level security;
alter table if exists public.refeicao_ia disable row level security;

grant select, insert, update, delete on public.registro_medicacao to anon, authenticated;
grant select, insert, update, delete on public.refeicao_ia to anon, authenticated;
