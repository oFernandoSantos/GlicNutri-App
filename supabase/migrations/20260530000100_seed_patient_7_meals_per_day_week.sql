-- Seed: 7 refeicoes/dia (todos os periodos do app) durante 7 dias
-- Pacientes reais (contas de login); ignora seed.demo e contas excluidas.
do $$
declare
...
begin
  if not exists (
    ...
    raise notice 'Paciente % nao encontrado. Seed 7 refeicoes/dia ignorado.', v_patient_id;
    return;
  end if;
  ...
  raise notice
    'Seed 7 refeicoes/dia aplicado para paciente % entre % e % (% registros).',
    v_patient_id,
    v_start_date,
    v_end_date,
    49;
