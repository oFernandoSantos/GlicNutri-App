...
const styles = StyleSheet.create({
  ...
  editBtnText: { fontSize: 12, fontWeight: '800', color: patientTheme.colors.primaryDark },
  ...
  primaryButton: { marginTop: 12, minHeight: 48, borderRadius: patientTheme.radius.pill, backgroundColor: patientTheme.colors.primaryDark, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 8 },
