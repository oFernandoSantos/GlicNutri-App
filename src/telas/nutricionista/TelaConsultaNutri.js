...
const styles = StyleSheet.create({
  ...
  actionBtnPrimary: { backgroundColor: patientTheme.colors.primaryDark },
  ...
  actionBtnSecondaryText: { color: patientTheme.colors.primaryDark, fontWeight: '900' },
  ...
  meetCard: { marginTop: 16, gap: 14, backgroundColor: patientTheme.colors.primarySoft, borderColor: patientTheme.colors.primarySoft },
  meetHeader: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  meetIcon: { width: 46, height: 46, borderRadius: 23, backgroundColor: patientTheme.colors.primaryDark, alignItems: 'center', justifyContent: 'center' },
  meetCopy: { flex: 1, minWidth: 0 },
  meetTitle: { color: patientTheme.colors.primaryDark, fontSize: 15, fontWeight: '900' },
