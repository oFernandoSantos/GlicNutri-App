"""
Treina modelos de demonstração a partir do CSV de exemplo e grava artefatos em machine-learning/api/artifacts/.
Execute após clonar o repositório ou substitua pelo pipeline do notebook.

  # na raiz do projeto GlicNutri:
  python machine-learning/api/scripts/fit_demo_models.py
"""
...
# Raiz do repositório GlicNutri (pai de machine-learning/)
ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", ".."))
CSV_DEFAULT = os.path.join(ROOT, "machine-learning", "data", "sample_glicnutri_patient_day.csv")
ARTIFACTS = os.path.join(ROOT, "machine-learning", "api", "artifacts")
